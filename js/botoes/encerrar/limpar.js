...
export default async function limpando() {
    ...
    localStorage.removeItem(`vs${suite}`)
    localStorage.removeItem(`vd${suite}`)
    localStorage.removeItem(`vst${suite}`)
    localStorage.removeItem(`permanencia${suite}`)
    localStorage.removeItem(`vc${suite}`)
    localStorage.removeItem(`va${suite}`)
    localStorage.removeItem(`troco${suite}`)
    localStorage.removeItem(`vpr${suite}`)
}
